...
\centering
%https://de.wikipedia.org/wiki/Von-Neumann-Architektur#/media/File:Von-Neumann_Architektur.svg
...
\cite{unikoelnvnz}.
%http://hki.uni-koeln.de/archive/hki2016/wisem-2011/basisinformationstechnologie-i/rechnertechnologie-i/arbeitsweise-einer-cpu-von-neumannzyklus.html
...
%http://wiki.osdev.org/Historical_Notes_on_CISC_and_RISC
%https://de.slideshare.net/SuvenduDash/cisc-risc-architecture
\subsection{RISC-Prozessoren}
%Quelle Studie suchen 
...
%Quelle unten: Taschenbuch Mikroprozessoren. Seite 85 RISC Ziele
\noindent
...
Außerdem soll ein Befehl genau einen Takt zur Ausführung benötigen. Wenn bei CISC ein Befehl in mehrere Mikrobefehle dekodiert wird, benötigen diese mehrere Takte bis alle ausgeführt wurden. Dies wird bei RISC vermieden. Jeder geladene Befehl wird dekodiert und in genau einem Takt abgearbeitet. Um Ein-Zyklus-Befehle umsetzen zu können, muss der Prozessor in seinem internen Aufbau extrem vereinfacht werden.
