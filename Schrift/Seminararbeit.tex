...
\hline
Takt & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Befehl\\ einlesen\end{tabular}} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Befehl \\ dekodieren\end{tabular}} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Operanden \\ einlesen\end{tabular}} & \multicolumn{1}{c}{Ausführen}    & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Ergebnisse \\ speichern\end{tabular}} \\ \hline
...
5    & \cellcolor[HTML]{FE996B}5.Befehl                                              & \cellcolor[HTML]{FFFE65}4.Befehl                                                 & \cellcolor[HTML]{67FD9A}3.Befehl                                                  & \cellcolor[HTML]{38FFF8}2.Befehl & \cellcolor[HTML]{9698ED}1.Befehl                                                    \\ \hline
6    &                                                                               & \cellcolor[HTML]{FE996B}5.Befehl                                                 & \cellcolor[HTML]{FFFE65}4.Befehl                                                  & \cellcolor[HTML]{67FD9A}3.Befehl & \cellcolor[HTML]{38FFF8}2.Befehl                                                    \\ \hline
7    &                                                                               &                                                                                  & \cellcolor[HTML]{FE996B}5.Befehl                                                  & \cellcolor[HTML]{FFFE65}4.Befehl & \cellcolor[HTML]{67FD9A}3.Befehl                                                    \\ \hline
\end{tabular}
\end{table}
%----------------------------------------------------------------------------------------------
